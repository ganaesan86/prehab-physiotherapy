  ...
  return (
    <footer className="footer">
      <div className="container footer__grid">
        ...
        {/* Brand — winged athlete logo */}
        <div className="footer__brand">
          <Link to="/" aria-label="Prehab Physiotherapy Home">
            <img
        ...
        <div className="footer__col">
          ...
          <ul className="footer__contact">
            ...
            <li>
              ...
              <span>10 Richmond Street, Unit 300<br />Maple, ON L6A 3Y8</span>
            </li>
            <li>
              <Clock size={15} className="footer__icon" />
